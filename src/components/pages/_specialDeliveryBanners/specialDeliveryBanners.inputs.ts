...
export const SpecialDeliveryBannersInputs = ({
  selectedStore,
  selectedCategory,
  selectedTargetType,
  onStoreChange,
  ...
  const targetType = selectedTargetType || "GENERAL";
  ...
  const inputs: FormInput[] = [
    ...
    },
    {
      ...
      cardId: "targeting",
      width: 3,
      disabled: targetType !== "EXTERNAL_URL"
    },
    {
      ...
      cardId: 'targeting',
      width: 3,
      disabled: targetType !== "CUSTOMER_CATEGORY",
    },
    {
      name: "storeId",
      type: "selectPaginated",
    ...
    },
    {
      ...
      cardId: 'targeting',
      width: 3,
      disabled: !needsCategory || !selectedStore,
    ...
    },
    {
      ...
      cardId: 'targeting',
      width: 3,
      disabled: !needsService || !selectedStore || !selectedCategory,
      searchFilters: selectedCategory ? [{ key: "categoryId", value: selectedCategory }] : []
    },
    {
      name: "zoneIds",
      type: "selectPaginated",
      apiUrl: selectedStore ? ["specialDeliveryBanners", "store", Number(selectedStore), "specialDeliveryBannersStoreZones"] : [],
      cardId: 'targeting',
      width: 3,
      isMulti: true,
      disabled: !needsZones || !selectedStore
    },
