...
function LoadingRoute() {
  ...
  const isDashboardRoute = /^\/(?:ar|en)\/(dashboard|logs|stores|orders|zones|branches|services|category|coupons|offers|banners|special-delivery-banners|modules|schedule|users|employees|customers|roles|permissions|fund|transactions|withdraw|complaint|socialMedia|rating|delivery|settings|profile|customer-categories|store-templates|analytics)(?:\/|$)/.test(location.pathname);
